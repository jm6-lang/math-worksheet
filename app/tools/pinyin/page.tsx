...
const PY: Record<string, string> = {
  ...
  '元': 'yuán', '角': 'jiǎo', '分': 'fēn', '零': 'líng', '两': 'liǎng',
  '上': 'shàng', '下': 'xià', '左': 'zuǒ', '右': 'yòu',
  '前': 'qián', '后': 'hòu', '中': 'zhōng', '里': 'lǐ', '外': 'wài',
  '东': 'dōng', '西': 'xī', '南': 'nán', '北': 'běi',
  '大': 'dà', '小': 'xiǎo', '多': 'duō', '少': 'shǎo',
  '高': 'gāo', '矮': 'ǎi', '长': 'cháng', '短': 'duǎn',
  '远': 'yuǎn', '近': 'jìn', '快': 'kuài', '慢': 'màn',
  '胖': 'pàng', '瘦': 'shòu', '重': 'zhòng', '轻': 'qīng',
  '春': 'chūn', '夏': 'xià', '秋': 'qiū', '冬': 'dōng',
  '日': 'rì', '月': 'yuè', '星': 'xīng', '雨': 'yǔ', '雪': 'xuě',
  '风': 'fēng', '云': 'yún', '雷': 'léi', '电': 'diàn',
  '冷': 'lěng', '热': 'rè', '温': 'wēn', '凉': 'liáng',
  '天': 'tiān', '地': 'dì', '和': 'hé', '年': 'nián',
  '山': 'shān', '水': 'shuǐ', '火': 'huǒ', '土': 'tǔ',
  '河': 'hé', '湖': 'hú', '海': 'hǎi', '江': 'jiāng',
  '林': 'lín', '森': 'sēn', '田': 'tián', '园': 'yuán',
  '花': 'huā', '草': 'cǎo', '树': 'shù', '木': 'mù', '果': 'guǒ',
  '鸟': 'niǎo', '虫': 'chóng', '鱼': 'yú',
  '马': 'mǎ', '牛': 'niú', '羊': 'yáng', '猪': 'zhū',
  '狗': 'gǒu', '猫': 'māo', '鸡': 'jī', '鸭': 'yā', '兔': 'tù',
  '爸': 'bà', '妈': 'mā', '爷': 'yé', '奶': 'nǎi',
  '哥': 'gē', '姐': 'jiě', '弟': 'dì', '妹': 'mèi',
  '叔': 'shū', '姑': 'gū', '舅': 'jiù', '姨': 'yí',
  '儿': 'ér', '子': 'zǐ', '女': 'nǚ', '家': 'jiā',
  '人': 'rén', '们': 'men', '我': 'wǒ', '你': 'nǐ',
  '他': 'tā', '她': 'tā', '它': 'tā',
  '朋': 'péng', '友': 'yǒu', '头': 'tóu',
  '目': 'mù', '眼': 'yǎn', '耳': 'ěr', '口': 'kǒu',
  '手': 'shǒu', '足': 'zú', '脚': 'jiǎo', '心': 'xīn',
  '身': 'shēn', '体': 'tǐ', '面': 'miàn',
  '本': 'běn', '书': 'shū', '笔': 'bǐ', '纸': 'zhǐ', '刀': 'dāo', '尺': 'chǐ',
  '课': 'kè', '作': 'zuò', '业': 'yè', '卷': 'juàn',
  '考': 'kǎo', '试': 'shì', '场': 'chǎng', '成': 'chéng', '绩': 'jì',
  '名': 'míng', '字': 'zì', '号': 'hào', '码': 'mǎ',
  '学': 'xué', '生': 'shēng', '老': 'lǎo', '师': 'shī', '校': 'xiào', '班': 'bān',
  '语': 'yǔ', '数': 'shù', '英': 'yīng', '音': 'yīn', '乐': 'yuè',
  '美': 'měi', '术': 'shù', '育': 'yù',
  '读': 'dú', '写': 'xiě', '看': 'kàn', '听': 'tīng', '说': 'shuō', '做': 'zuò',
  '会': 'huì', '能': 'néng', '要': 'yào', '想': 'xiǎng', '爱': 'ài', '好': 'hǎo',
  '开': 'kāi', '关': 'guān', '进': 'jìn', '出': 'chū',
  '回': 'huí', '到': 'dào', '去': 'qù', '来': 'lái',
  '打': 'dǎ', '找': 'zhǎo', '给': 'gěi', '让': 'ràng', '叫': 'jiào', '请': 'qǐng',
  '问': 'wèn', '答': 'dá', '玩': 'wán', '唱': 'chàng', '跳': 'tiào', '画': 'huà',
  '跑': 'pǎo', '走': 'zǒu', '飞': 'fēi', '坐': 'zuò', '站': 'zhàn',
  '吃': 'chī', '喝': 'hē', '睡': 'shuì', '醒': 'xǐng',
  '洗': 'xǐ', '穿': 'chuān', '戴': 'dài', '拿': 'ná', '放': 'fàng', '收': 'shōu',
  '买': 'mǎi', '卖': 'mài', '送': 'sòng', '接': 'jiē', '帮': 'bāng', '助': 'zhù',
  '新': 'xīn', '旧': 'jiù', '老': 'lǎo', '少': 'shào', '轻': 'qīng',
  '努': 'nǔ', '力': 'lì', '勤': 'qín', '懒': 'lǎn',
  '干': 'gàn', '净': 'jìng', '脏': 'zāng',
  '真': 'zhēn', '假': 'jiǎ', '对': 'duì', '错': 'cuò',
  '漂': 'piào', '亮': 'liang', '丑': 'chǒu', '帅': 'shuài',
  '甜': 'tián', '酸': 'suān', '苦': 'kǔ', '辣': 'là', '咸': 'xián',
  '聪': 'cōng', '明': 'míng', '勇': 'yǒng', '敢': 'gǎn',
  '可': 'kě', '欢': 'huān', '怕': 'pà', '哭': 'kū', '笑': 'xiào', '疼': 'téng',
  '饿': 'è', '渴': 'kě', '累': 'lèi', '困': 'kùn',
  '忙': 'máng', '闲': 'xián', '早': 'zǎo', '晚': 'wǎn', '迟': 'chí',
  '红': 'hóng', '黄': 'huáng', '蓝': 'lán', '绿': 'lǜ', '青': 'qīng',
  '白': 'bái', '黑': 'hēi', '紫': 'zǐ', '橙': 'chéng', '灰': 'huī',
  '兴': 'xìng', '乐': 'lè', '难': 'nán', '过': 'guò', '伤': 'shāng',
  '谢': 'xiè', '起': 'qǐ', '没': 'méi', '系': 'xì',
  '客': 'kè', '气': 'qì', '不': 'bù', '用': 'yòng',
  '时': 'shí', '分': 'fēn', '秒': 'miǎo',
  '今': 'jīn', '昨': 'zuó', '明': 'míng', '天': 'tiān',
  '上': 'shàng', '午': 'wǔ', '半': 'bàn', '夜': 'yè', '刻': 'kè',
  '期': 'qī', '现': 'xiàn', '以': 'yǐ', '后': 'hòu', '前': 'qián',
  '门': 'mén', '房': 'fáng', '间': 'jiān',
  '厅': 'tīng', '厨': 'chú', '卫': 'wèi',
  '阳': 'yáng', '台': 'tái', '卧': 'wò', '室': 'shì',
  '床': 'chuáng', '桌': 'zhuō', '椅': 'yǐ', '灯': 'dēng', '钟': 'zhōng',
  '沙': 'shā', '发': 'fā', '窗': 'chuāng', '帘': 'lián', '毯': 'tǎn',
  '院': 'yuàn', '街': 'jiē', '店': 'diàn',
  '公': 'gōng', '园': 'yuán', '超': 'chāo', '市': 'shì',
  '医': 'yī', '院': 'yuàn', '药': 'yào', '病': 'bìng',
  '图': 'tú', '馆': 'guǎn', '饭': 'fàn', '菜': 'cài',
  '汤': 'tāng', '肉': 'ròu', '蛋': 'dàn', '奶': 'nǎi',
  '米': 'mǐ', '面': 'miàn', '包': 'bāo', '油': 'yóu', '盐': 'yán', '糖': 'táng', '茶': 'chá',
  '豆': 'dòu', '腐': 'fu', '馒': 'mán', '头': 'tou',
  '土': 'tǔ', '洋': 'yáng', '葱': 'cōng', '萝': 'luó', '卜': 'bo',
  '瓜': 'guā', '茄': 'qié', '椒': 'jiāo',
  '葡': 'pú', '萄': 'tao', '西': 'xī',
  '苹': 'píng', '香': 'xiāng', '蕉': 'jiāo',
  '橘': 'jú', '柠': 'níng', '檬': 'méng',
  '核': 'hé', '桃': 'tao', '栗': 'lì', '莓': 'méi', '樱': 'yīng',
  '很': 'hěn', '都': 'dōu', '还': 'hái', '又': 'yòu', '也': 'yě', '就': 'jiù',
  '最': 'zuì', '更': 'gèng', '再': 'zài', '已': 'yǐ', '刚': 'gāng',
  '把': 'bǎ', '被': 'bèi', '跟': 'gēn', '像': 'xiàng', '样': 'yàng',
  '国': 'guó', '城': 'chéng', '村': 'cūn', '路': 'lù', '桥': 'qiáo',
  '车': 'chē', '船': 'chuán', '机': 'jī',
  '脑': 'nǎo', '视': 'shì', '空': 'kōng', '调': 'tiáo',
  '冰': 'bīng', '箱': 'xiāng', '衣': 'yī',
  '袜': 'wà', '鞋': 'xié', '帽': 'mào', '伞': 'sǎn',
  '铅': 'qiān', '圆': 'yuán', '珠': 'zhū', '钢': 'gāng', '墨': 'mò',
  '电': 'diàn', '习': 'xí', '练': 'liàn',
  '认': 'rèn', '真': 'zhēn', '细': 'xì', '虎': 'hu', '心': 'xīn',
  '注': 'zhù', '意': 'yì', '关': 'guān',
  '见': 'jiàn', '您': 'nín',
  '知': 'zhī', '道': 'dào',
  '饭': 'fàn', '学': 'xué', '校': 'xiào',
  '院': 'yuàn', '馆': 'guǎn', '店': 'diàn',
  // === 词组（按拼音排序，避免重复）===
  '早上好': 'zǎo shang hǎo', '下午好': 'xià wǔ hǎo', '晚上好': 'wǎn shang hǎo',
  '大家好': 'dà jiā hǎo', '老师好': 'lǎo shī hǎo',
  '再见': 'zài jiàn', '谢谢': 'xiè xie',
  '对不起': 'duì bu qǐ', '没关系': 'méi guān xi',
  '不可以': 'bù kě yǐ', '不知道': 'bù zhī dào',
  '不相信': 'bù xiāng xìn', '不明白': 'bù míng bái',
  '不喜欢': 'bù xǐ huān', '不会': 'bù huì',
  '不能': 'bù néng', '不要': 'bù yào',
  '不明白': 'bù míng bái', '不喜欢': 'bù xǐ huān',
  '不相信': 'bù xiāng xìn', '不明白': 'bù míng bái',
  '明白': 'míng bái', '喜欢': 'xǐ huān', '讨厌': 'tǎo yàn',
  '希望': 'xī wàng', '开始': 'kāi shǐ', '结束': 'jié shù', '继续': 'jì xù',
  ...
  '北京': 'běi jīng', '中国': 'zhōng guó',
  '小学生': 'xiǎo xué shēng', '小朋友': 'xiǎo péng yǒu',
  '哥哥': 'gē ge', '姐姐': 'jiě jie', '弟弟': 'dì di', '妹妹': 'mèi mei',
  '我们': 'wǒ men', '你们': 'nǐ men', '他们': 'tā men',
  '这个': 'zhè ge', '那个': 'nà ge', '哪个': 'nǎ ge',
  '这里': 'zhè lǐ', '那里': 'nà lǐ', '哪里': 'nǎ lǐ',
  '有的': 'yǒu de', '没有': 'méi yǒu',
  '是的': 'shì de', '不是': 'bù shì',
  '好的': 'hǎo de', '会': 'huì',
  '可以': 'kě yǐ', '应该': 'yīng gāi',
  '愿意': 'yuàn yì', '肯': 'kěn', '敢': 'gǎn',
  '高兴': 'gāo xìng', '开心': 'kāi xīn', '快乐': 'kuài lè',
  '难过': 'nán guò', '伤心': 'shāng xīn',
  '检查': 'jiǎn chá', '复习': 'fù xí', '预习': 'yù xí',
  '考试': 'kǎo shì', '及格': 'jí gé', '优秀': 'yōu xiù',
  '很好': 'hěn hǎo', '不好': 'bù hǎo', '非常': 'fēi cháng',
  '特别': 'tè bié', '大概': 'dà gài', '也许': 'yě xǔ',
  '必须': 'bù xū', '不必': 'bù bì', '不用': 'bù yòng',
  '已经': 'yǐ jīng', '经常': 'jīng cháng', '总是': 'zǒng shì',
  '马上': 'mǎ shàng', '立刻': 'lì kè', '然后': 'rán hòu',
  '但是': 'dàn shì', '如果': 'rú guǒ', '因为': 'yīn wèi',
  '所以': 'suǒ yǐ', '虽然': 'suī rán', '还是': 'hái shi',
  '关于': 'guān yú', '对于': 'duì yú',
  '第一': 'dì yī', '一半': 'yī bàn', '一共': 'yī gòng',
  '大约': 'dà yuē', '左右': 'zuǒ yòu',
  '差不多': 'chà bu duō', '差一点': 'chà yī diǎn',
  '一定': 'yī dìng', '肯定': 'kěn dìng',
  '突然': 'tū rán', '忽然': 'hū rán',
  '非常': 'fēi cháng', '十分': 'shí fēn', '特别': 'tè bié',
};
